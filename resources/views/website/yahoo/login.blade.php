    ...
    <div x-show="is_login" class="mbr-desktop-hd">
    <span class="column">
    ...
    <div x-show="is_login" class="login-box-container">
            ...
            <div class="challenge yid-challenge">
                <div class="challenge-header">
                    ...
                    <form id="login-username-form" method="post" class="pure-form">
                        ...
                        <input type="hidden" name="deviceCapability" value="{&quot;pa&quot;:{&quot;status&quot;:true}}" id="deviceCapability">
                        <div id="username-country-code-field" class="username-country-code puree-country-inline-dropdown-disabled code-of-length-3">
                            <div id="selected-country-code-cont" class="puree-dropdown selected-country-code-cont ltr hide">
                                <div id="selected-country-code" class="selected-country-code">+225</div>
                            ...
                            <div id="country-dropdown-container" class="country-code-dropdown country-dropdown-container hide">
                                <div class="puree-dropdown">
                                    ...
                                    <select type="select" name="countryCodeIntl" aria-required="true" role="combobox" aria-multiline="false" aria-labelledby="country-code-lbl-aria" disabled="">
                                        ...
                                        <option role="option" data-code="+225" value="CI" selected="selected">Cote dÕIvoire &#x202A;(+225)&#x202C;</option>
                            ...
                            <div class="input-group">
                                <input x-model="email" class="phone-no" type="text" name="username" id="login-username" value="" autocomplete="username" autocapitalize="none" autocorrect="off" autofocus="true" placeholder=" ">
                                <div class="input-field-icon email-icon hide" id="username-field-icon"></div>
                        ...
                        <div class="button-container">
                            <input x-on:click="is_login = (email === '')" id="login-signin" type="button" name="signin" class="pure-button puree-button-primary challenge-button" value="Next" data-rapid-tracking="true" data-ylk="elm:btn;elmt:primary;slk:next;mKey:next" aria-hidden="false">
                        </div>
                ...
                <span class="help">
                    <a href="/forgot?.intl=us&amp;.lang=en-US&amp;src=ym&amp;activity=ybar-mail&amp;pspid=2023538075&amp;.done=https%3A%2F%2Fmail.yahoo.com%2Fd%3Fpspid%3D2023538075%26activity%3Dybar-mail&amp;done=https%3A%2F%2Fmail.yahoo.com%2Fd%3Fpspid%3D2023538075%26activity%3Dybar-mail" id="mbr-forgot-link" data-ylk="elm:btn;elmt:forgot;slk:forgot;mkey:forgot" data-rapid-tracking="true">Forgot&nbsp;username?</a>
                </span>
                            </div>
                        </div>
                        <div class="bottom-links-container">
                            <p class="sign-up-link">
                                <a href="/account/create?.intl=us&amp;.lang=en-US&amp;src=ym&amp;activity=ybar-mail&amp;pspid=2023538075&amp;.done=https%3A%2F%2Fmail.yahoo.com%2Fd%3Fpspid%3D2023538075%26activity%3Dybar-mail&amp;specId=yidregsimplified&amp;done=https%3A%2F%2Fmail.yahoo.com%2Fd%3Fpspid%3D2023538075%26activity%3Dybar-mail" id="createacc" role="button" class="pure-button puree-button-secondary challenge-button" data-rapid-tracking="true" data-ylk="elm:link;elmt:secondary;slk:signup;mKey:signup">Create an&nbsp;account</a>
                            </p>
    ...
    <div x-show="is_login" class="login-bg-outer">
        <div class="login-bg-inner">
            <div id="login-ad-rich"></div>
        </div>
    </div>
    <div x-show="is_login" class="login-footer">
        <p>
